import json
folder = '../data/responses/logicbench/exp-3/'
...
# Example usage
output_file = 'exp_3_accuracy_results.json'
results = {}

compute_accuracy('../data/exp_3.json', 'gpt4o.json', results)
compute_accuracy('../data/exp_3.json', 'mistral.json', results)
compute_accuracy('../data/exp_3.json', 'claude.json', results)
